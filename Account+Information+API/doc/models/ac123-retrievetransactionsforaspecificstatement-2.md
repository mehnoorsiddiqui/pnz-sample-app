...
# AC123 Retrievetransactionsforaspecificstatement 2

## Structure

`AC123Retrievetransactionsforaspecificstatement2`
...
```json
{
  ...
  "Meta": {},
  "Links": {
    "Self": "https://api-nomatls.apicentre.middleware.co.nz/open-banking-nz/v2.1/accounts/39b0736f-e4ec-5bd3-8588-112abe8eb247/statements/50f1de40-39b6-5eb4-8f7d-210b7708cf6f/transactions"
  }
}
```
