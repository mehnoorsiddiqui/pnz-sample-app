...
export interface ExampleA9Retrievebulkdirectdebits {
  data: Data5;
  meta?: unknown;
  links: Links;
}

export const exampleA9RetrievebulkdirectdebitsSchema: Schema<ExampleA9Retrievebulkdirectdebits> = object(
  {
