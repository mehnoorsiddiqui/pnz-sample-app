...
export interface AC119Retrieveaccounttransactions2 {
  data: Data83;
  meta?: unknown;
  links: Links;
}

export const aC119Retrieveaccounttransactions2Schema: Schema<AC119Retrieveaccounttransactions2> = object(
  {
